        ...
        <section class="bg-white">
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-emerald-600">Gardez le contrôle sur votre traçabilité</h2>
                    <p class="mb-5 font-light text-gray-500 sm:text-xl">
                        HPM Food Tracking vous permets de gérer de manière efficiente la traçabilité et l'hygiène de votre commerce.
                        Notre but est de vous permettre de vous concentrer sur l'essentiel.
                    </p>
                </div>
                <div class="space-y-8 sm:gap-6 xl:gap-10 lg:space-y-0">
                    ...
                    <div
                        ...
                        <h3 class="text-2xl font-semibold">Abonnement HPM</h3>
